...
class LocalMetadataExtractor @Inject constructor(
    ...
    private val filenameMetadataExtractor: FilenameMetadataExtractor
) : MetadataExtractor {
    override suspend fun extract(sourceUri: String, displayName: String): BookMetadata =
        withContext(Dispatchers.IO) {
            ...
            val extension = displayName.contentExtension()
            ...
            runCatching {
                ...
                filenameMetadataExtractor.extract(sourceUri, displayName)
            }
        }
