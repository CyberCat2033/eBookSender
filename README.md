...
- Просмотр каталога подключенной читалки, удаление файлов и папок с подтверждением.
...
Требования: Android 8.0+ и читалка с FTP-сервером в той же локальной сети.
