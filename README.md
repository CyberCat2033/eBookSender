...
Если пользователь отменил системную установку, скачанный APK остается во внутреннем кеше приложения. Повторная установка использует кеш только при совпадении актуального манифеста и SHA-256; устаревшие или поврежденные APK удаляются и скачиваются заново. Кнопка **«Очистить кэш загрузок»** в настройках также удаляет кеш APK обновлений.
