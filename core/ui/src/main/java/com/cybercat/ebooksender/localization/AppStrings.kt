...
class AppStrings(
    ...
    val settingsCheckUpdates: String get() = get("settings_check_updates")
    val settingsCheckingUpdates: String get() = get("settings_checking_updates")
    val settingsInstallUpdate: String get() = get("settings_install_update")
    val settingsCurrentVersion: String get() = get("settings_current_version")
    val settingsUpdateAvailable: String get() = get("settings_update_available")
    ...
    val updateNoUpdate: String get() = get("update_no_update")
    val updateErrorNetwork: String get() = get("update_error_network")
    val updateErrorInvalidManifest: String get() = get("update_error_invalid_manifest")
    val updateErrorNoCompatibleArtifact: String get() = get("update_error_no_compatible_artifact")
    val updateErrorDownloadFailed: String get() = get("update_error_download_failed")
    val updateErrorChecksumMismatch: String get() = get("update_error_checksum_mismatch")
