...
- `app/src/main/java/com/cybercat/ebooksender/transfer/MetadataExtractionDispatcher.kt` - bounded metadata-work dispatcher used by the upload queue; owns pending/running item sets, prioritization, worker signaling, and parallelism control.
