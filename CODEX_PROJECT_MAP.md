...
- `app/src/main/java/com/cybercat/ebooksender/ui/AppUpdateDialog.kt` - global Material 3 dialog shown when the app-open or manual update check finds a newer version; includes a scrollable localized changelog section when the manifest provides changelog URLs.
